...
const Past = () => {
  ...
  const oldNotificationsCards = [
    ...
    },
    {
      category: 'Default',
      name: 'Wayne',
      message: "Hey Wayne! Don't forget, June 21st is Father's Day 🎁 Check out and shop our collection of brands that dads love.",
      time: '6m'
    }
  ]
        ...
        <View style={{ paddingHorizontal: normalize(12), justifyContent: 'center', alignItems: 'center', flex: 1 }}>
          ...
          <View style={styles.descHolder}>
            <AppText
              ...
              Get projects, buy and sell items, start your own online business, or just bookmark posts—do all these and more on Servbees.
              </AppText>
          </View>
          <TouchableOpacity
            style={{ paddingVertical: normalize(10), paddingHorizontal: normalize(20), alignItems: 'center', justifyContent: 'center', flexDirection: 'row', backgroundColor: '#FFD400', borderRadius: 3 }}
          ...
          <ScrollView style={{ paddingTop: normalize(20), paddingTop: normalize(30) }}>
