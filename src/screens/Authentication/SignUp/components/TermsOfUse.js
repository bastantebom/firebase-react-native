  ...
  return (
    <Modal isVisible={isVisible}>
      <View style={styles.modalWrapper}>
        ...
        <ScrollView>
          <AppViewContainer>
            <AppText textStyle="display5">Terms of Use</AppText>
          </AppViewContainer>
          <AppViewContainer customStyle={styles.contentWrapper}>
            ...
            <View style={{ marginTop: normalize(24) }}>
              <AppText textStyle="body1">
                ...
                allows its customers (“Customers”) to access Servbees’s network
                of contractors (“Servbees” or “you” or “Contractor”) to identify
                and transact with local providers to meet intermittent needs for
            ...
            <View style={{ marginTop: normalize(24) }}>
              <AppText textStyle="body1">
                ...
                <AppText textStyle="body1medium">“Servbees“</AppText>).
                References to{' '}
                <AppText textStyle="body1medium">“Servbees“</AppText>,{' '}
                ...
                and references to{' '}
                <AppText textStyle="body1medium">“you“</AppText>,{' '}
            ...
            <View style={{ marginTop: normalize(24) }}>
              <AppText textStyle="body1">
                ...
                full legal authority to bind your employer or the applicable
                entity to this Agreement; (b) you have read and understood the
                contents of this Agreement; and (c) you agree, on behalf of your
                employer or the entity you represent, to this Agreement. If you
                do not have the legal authority to bind your employer or the
                applicable entity to this Agreement, you must not on behalf of
                your employer or the applicable entity sign up for an Account
                (as defined below), use any Account (as defined below), use the
                Platform (as defined below) or otherwise communicate any
                acceptance of this Agreement to Servbees.
              </AppText>
            </View>
            ...
            <View
              ...
              <View
                ...
                <AppText
                  ...
                  links, artwork, animations, illustrations, data, material,
                ...
                <AppText
                  ...
                  limited to, verification of mobile phone number, verification
                  of payment information, references or integration with third
                ...
                <AppText
                  ...
                  means, with respect to a Service Contract, the completion of
                  the Services thereunder, as determined in accordance with
                  clause 4.6.
                </AppText>
                <AppText
                  textStyle="body1"
                ...
                <AppText
                  ...
                  completing additional work which the Service Recipient agrees
                  to reimburse.
                </AppText>
                <AppText
                  textStyle="body1"
            ...
            <View
              ...
              <View
                ...
                <AppText
                  ...
                  used in relation to personal data) shall have the meanings
                  given to them in the Personal Data Protection Act 2012 (Act 26
                  of 2012) of Singapore;
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{ marginTop: normalize(8) }}>
            ...
            <View
              ...
              <View
                ...
                <AppText
                  ...
                  amend and/or notify you of on the Platform.
                </AppText>
              </View>
              <AppText
                textStyle="body1"
                ...
                the fulfilment of Service Contracts. We are not responsible for
                the performance, communications, or any aspect of interaction
                between the Users and we make no representation or warranty as
                to the truth or accuracy of any aspect of any information
                provided by any User. We do not guarantee the fulfilment of any
                Task Postings, Task Offers and/or Service Contracts and you
                agree to assume all risks of non-performance and non-payment. We
                do not have control over the quality, timing, legality, failure
                to provide, or any aspect whatsoever of the Task Postings, the
                Task Offers, the Service Contracts, the Services and/or the
                Users (including, but not limited to, the ability of any User to
                perform tasks, supply items, or pay for the services requested).
              </AppText>
              ...
              <AppText
                ...
                cost and expense for all connections and/or equipment required
                to use the Platform.
              </AppText>
              <AppText
                textStyle="body1"
            ...
            <View
              ...
              <AppText
                ...
                and documents as we may from time to time require. We may in our
                sole discretion refuse to open an Account for you or limit the
                number of Accounts that you may hold.
              </AppText>
              <AppText
                textStyle="body1"
                customStyle={{ marginTop: normalize(24) }}>
                ...
                your Account, we may from time to time prohibit access to your
                Account from or by any device which we in our sole discretion
                deem to be a risk to the security of your Account. You are
                solely responsible for the security of your Account login
                credentials and other forms of authentication and must keep all
                login credentials and other forms of authentication strictly
                secret and confidential. You are responsible for all activities
                that occurs in or through your Account, and you shall have no
                claim against us in connection with us acting in reliance of the
                instructions given or sent from your Account.
              </AppText>
              <AppText
                textStyle="body1"
                customStyle={{ marginTop: normalize(24) }}>
                ...
                any investigation or court order; (c) any suspicious or illegal
                activity being detected on your Account; or (d) any other
                reason. If your Account is suspended, then for the duration of
                such suspension you may not be able to use the Platform and
                notwithstanding any provision to the contrary, all withdrawals
                of Task Fees due to your Account (where applicable) shall not be
                allowed. Any waiver or exception to the aforesaid shall be in
                our sole and absolute discretion on a case-by-case basis,
              </AppText>
              <AppText
                textStyle="body1"
                customStyle={{ marginTop: normalize(24) }}>
                ...
                activity being detected on your Account; or (d) any other
                reason. You may also submit a request for us to close your
                Account.
              </AppText>
              ...
              <AppText
                ...
                responsibility for the accuracy or reliability of Identity
                Checks information or any information provided through the
                Platform.
              </AppText>
            </View>
            <View style={{ marginTop: normalize(24) }}>
            ...
            <View
              ...
              <View
                ...
                <AppText
                  ...
                  on or through the Platform for the purpose of publishing
                  materials on the Platform and as otherwise may be required to
                  provide the Platform, for the general promotion of the
                  Platform, and as permitted by this Agreement.
                </AppText>
              </View>
            </View>
            <View
              ...
              <View
                ...
                <AppText
                  ...
                  Recipient. We advise Service Providers not to agree to incur
                  any costs in advance of receiving payment from the Service
                  Recipient. We advise Service Providers to retain all
                  supporting documents of the cost incurred.
                </AppText>
              </View>
            </View>
            <View
            ...
            <View
              ...
              <View
                ...
                <AppText
                  ...
                  legal and binding agreement with the offeror of the Task
                  Offer;
                </AppText>
                <AppText
                  textStyle="body1"
                ...
                <AppText
                  ...
                  person present when the Services are performed and/or
                  completed (for example, your spouse or friend) shall be deemed
                  your agent and the Service Provider may take and follow such
                  agent’s direction as if given by yourself;
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{ marginTop: normalize(8) }}>
            ...
            <View
              ...
              <AppText
                ...
                fees and you are solely responsible for any third party consents
            ...
            <View
              ...
              <AppText
                ...
                request, we at our absolute discretion agree to assist in a
                dispute between you and that User:
              </AppText>
              <View
                style={{
                  marginTop: normalize(8),
                ...
                <AppText
                  ...
                  legal proceedings against that User in an applicable court of
                  law;
                </AppText>
                <AppText
                  textStyle="body1"
                ...
                <AppText
                  ...
                  payment, return and/or release of the Task Fees accordingly;
                  and
                </AppText>
                <AppText
                  textStyle="body1"
                  ...
                  you acknowledge and agree that under no circumstances shall we
                  have any liability nor obligation to offer any refunds.
                </AppText>
              </View>
              <AppText
                textStyle="body1"
                ...
                whatsoever reason to remove any Content, Task Posting and/or
                Task Offer that you have submitted to the Platform or to cancel
                or suspend your Account, any Task Posting, any Task Offer and/or
              ...
              <AppText
                ...
                case may be) and work or receive services in the jurisdictions
                in which the Services are performed (as the case may be). You
                are solely responsible for complying with all tax, legal
                regulatory obligations in relation to any Services rendered or
                received, or payment made or received, pursuant to a Service
                Contract.
              </AppText>
            </View>
            <View style={{ marginTop: normalize(24) }}>
            ...
            <View
              ...
              <View
                ...
                <View
                  ...
                  <AppText textStyle="body1">
                    1. all of our fees set out in the Subscription Fees, as we
                    may from time to time revise in our sole discretion; and
                  </AppText>
                  <AppText
                    textStyle="body1"
                    customStyle={{ marginTop: normalize(8) }}>
                ...
                <View
                  ...
                  <AppText
                    ...
                    us with, you represent and warrant that you have all
                    necessary consents and approvals to use such credit or debit
                    card and that we are authorized to disclose such credit or
                    debit card details to our third party payment processors.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    customStyle={{ marginTop: normalize(8) }}>
                ...
                <View
                  ...
                  <AppText
                    ...
                    through an authorisation or such other reasonable
                    procedures.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    ...
                    any other applicable fees chargeable hereunder in respect of
                    the Task Offer. Such authorisation shall include any
                    extension or renewal of such card authorisation hold for so
                    long as Task Completion is not achieved or (if applicable)
                    until such time any dispute between the relevant Users is
                    resolved.
                  </AppText>
                  <AppText
                    textStyle="body1"
                ...
                <View
                  ...
                  <View
                    ...
                    <AppText
                      ...
                      rescinded, removed or termination, or for whatsoever
                      reason in our absolute discretion; or
                    </AppText>
                    <AppText
                      textStyle="body1"
                      customStyle={{ marginTop: normalize(8) }}>
                ...
                <AppText
                  ...
                  obtaining reimbursement from the Service Recipient directly
                  or, if permitted by us, through the Platform (in which event
                ...
                <AppText
                  ...
                  (a) there are at any time any fees owed to us; (b) there is
                  any transaction error resulting in decline or chargeback from
                  a financial institution; (c) we believe that your credit or
                  debit card has been used fraudulently, illegally or involves
                  criminal activity; or (d) we believe that you are in breach of
                  this Agreement.
                </AppText>
                <AppText
                  textStyle="body1"
                  ...
                  without prejudice to any other remedies available to us, set
                  off any amounts due to you against any obligation owed by you
                  to us, whether present or future, actual or contingent,
                  liquidated or unliquidated, primary or collateral, several or
                  joint.
                </AppText>
                <AppText
                  textStyle="body1"
                  ...
                  operate your Account or use the Platform, you agree to be
                  bound by the Stripe Services Agreement, as the same may be
                  modified by Stripe from time to time. As a condition of us
                  enabling payment processing services through Stripe, you agree
                  to provide us with accurate and complete information about you
                  and your business, and you authorise us to share it with
                  Stripe along with any transaction information related to your
            ...
            <View
              ...
              <AppText
                ...
                closure of your Account, all Services and uncompleted
                transactions associated with your Account shall be terminated
                immediately and all fees, costs and expenses accruing to us
                under this Agreement shall be immediately become due and
                payable, and you must immediately settle all such fees, costs
              ...
              <View
                ...
                <View
                  ...
                  <AppText
                    ...
                    Posting and/or a Task Offer) and the performance and receipt
                    of the Services;
                  </AppText>
                  <AppText
                    textStyle="body1"
                  ...
                  <AppText
                    ...
                    listservs, or any kind of auto-responder or spam on or
                  ...
                  <AppText
                    ...
                    the Platform; (b) the use of the Platform by any other User;
                    or (c) measures put in place to prohibit or prevent you from
                  ...
                  <AppText
                    ...
                    Content, reverse engineer or take apart any aspect of the
                    Platform to access any underlying information, or use any
                    kind of software to crawl, spider or index any part of the
                    Platform;
                  </AppText>
                  <AppText
                    textStyle="body1"
            ...
            <View style={{ marginTop: normalize(24) }}>
              ...
              <View
                ...
                <AppText
                  ...
                  rights or obligations in respect of our intellectual property
                  rights and our Content are granted to you or are to be implied
                  from this Agreement.
                </AppText>
                <AppText
                  textStyle="body1"
                  ...
                  Content, except that whenever you submit User Content to us
                  (whether using the Platform or otherwise):
                </AppText>
                <View
                  style={{
                    marginTop: normalize(8),
                  ...
                  <AppText
                    ...
                    transferable licence to use, display, exploit, change, edit,
                    modify, create derivatives of and translate the User Content
                    for any purpose; and
                  </AppText>
                  ...
                  <AppText
                    ...
                    manner set forth in this Agreement; (b) your User Content
                    does not and will not infringe upon the intellectual
                    property rights, proprietary rights, privacy rights,
                    confidentiality, moral rights, rights of publicity of any
                    third party or otherwise violate the provisions of this
                    Agreement or any applicable law; and (c) we will not need to
                    obtain any rights, licences, consents or permissions from
                    (or make any payments to) any third party for any use of
                    your User Content or have any liability to any person or
                    third party as a result of any use or exploitation of your
                    User Content.
                  </AppText>
                </View>
                <AppText
                  ...
                  Platform without notice to you.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{ marginTop: normalize(8) }}>
                  ...
                  solely in connection with your use of the Platform in
                  accordance with this Agreement. You undertake not to
                  reproduce, redistribute, transmit, assign, sell, broadcast,
                  rent, share, lend modify, adapt, edit, create derivative works
                  out of, licence or otherwise transfer or use any User Content
                  or our Content without our prior written consent. We shall be
                  entitled to revoke this licence to access and use the User
                  Content and our Content at any time.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{ marginTop: normalize(8) }}>
            ...
            <View style={{ marginTop: normalize(24) }}>
              ...
              <View
                ...
                <AppText
                  ...
                  all personal data (as disclosed to us by you) in accordance
                ...
                <AppText
                  ...
                  2. Disclosure to Us. Each time you disclose any personal data
                  to us, you are representing and warranting to us that:
                </AppText>
                <View
                  style={{
                    marginTop: normalize(8),
                  ...
                  <AppText
                    ...
                    1. the relevant individuals have consented to the
                    collection, use, disclosure, storage, retention, processing
                    and transmission of their personal data by us in accordance
                  ...
                  <AppText
                    ...
                    individuals as required under applicable laws (including,
                    but not limited to, the Personal Data Protection Act of
                    Singapore) have been obtained, such that we may collect,
                    use, disclose, store, retain, process and transmit the
                    personal data of such individuals in accordance with our
                    Privacy Policy.
                  </AppText>
                </View>
                <AppText
                  ...
                  3. Other User’s Personal Data. When you use the Platform,
                  create a Task Posting, make a Task Offer, enter into the
                  Service Contract, receive the Services, or provide the
                  Services, you may receive information about other Users
                  including their personal data. You acknowledge and agree that
                  such information is provided purely for the purpose of
                  fulfilling the Services for the applicable Task Posting, Task
                  Offer and/or Service Contract and may not be used for other
                  purposes (including, but not limited to, marketing) without
                  separate verifiable consent from the User. You will maintain
                  records of all such verifiable consent.
                </AppText>
              </View>
            </View>
            <View style={{ marginTop: normalize(24) }}>
              ...
              <View
                ...
                <AppText
                  ...
                  applicable laws, the Platform, our Content, User Content and
                  any other materials made available on the Platform are
                  provided on an “as is”, “where is” and “as available” basis
                  without representations and warranties of any kind whatsoever.
                  No opinion, advice or statement of us or of our affiliates,
                  licensors, suppliers, advertisers, sponsors, agents, members
                  or visitors, whether made through the Platform, or on third
                  party platforms or otherwise, shall create any representation
                  or warranty. Your access or use of the Platform and the
                  Services is entirely at your own risk and you shall have no
                  recourse whatsoever to us. To the fullest extent permissible
                  under applicable laws, we expressly disclaim any and all
                  representations and warranties (whether express or implied)
                  including, but not limited to, the implied warranties of
                  security, merchantability, satisfactory quality,
                  functionality, fitness for a particular purpose, availability,
                  title, freedom from malicious code and non-infringement.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{
                  ...
                  2. Disclaimer of Liabilities. To the fullest extent
                  permissible under applicable laws, we expressly disclaim (and
                  you expressly release us from) all liabilities for (a) the
                  truth, accuracy, adequacy, completeness or reasonableness of
                  any Content contained in or accessed through the Platform; (b)
                  the Platform being interrupted or suffering from errors, loss,
                  corruption, attack, virus, interference, hacking or other
                  security intrusions; (c) your inability to open, use or view
                  any Content; (d) the reliability, validity, accuracy or
                  truthfulness of any Content; (e) any damages or losses
                  relating to your use or attempted use of the Platform; (f) any
                  act or omission of any User; (g) the Services (including but
                  not limited to the reliability, safety, timeliness, quality,
                  suitability or availability thereof) and/or the Service
                  Contract; (h) any act, omission, damages or loss suffered by
                  you following a period of any unavailability of the Platform;
                  (i) any act, omission, damages or loss arising from any
                  instructions given from your Account which we have relied
                  and/or acted upon; (j) damages or losses arising from your
                  failure to fulfil any of your obligations hereunder; (k) loss
                  of profits, loss of anticipated savings, loss of business,
                  ...
                  foreseeable or not; (l) losses caused by or in connection with
                  death or personal injury due to your negligence, fraud or
                  wilful misconduct; (m) losses arising from any breach of
                  applicable data protection laws due to your failure to obtain
                  and maintain the relevant consents in order for us to provide
                  the Services pursuant to the provisions hereunder; (n) loss of
                  data, information and records (howsoever caused) and computer
                  malfunction; (o) loss arising from any cause whatsoever
                  through no fault of us (including, but not limited to, any
                  computer or system virus interference, sabotage or any other
                  causes whatsoever which may interfere with your computer
                  systems, and any loss of, destruction to or error in your
                  data, information and records, howsoever caused); (p) damages
                  or losses arising from the provision of any Services which are
                  prohibited by law (including but not limited to the carriage
                  of dangerous or hazardous materials, radioactive materials,
                  explosives, illegal narcotics, or any other items which are
                  prohibited by law); and (q) any claims, demands or damages
                  (whether actual, consequential or otherwise) of any kind or
                  nature arising out of or in any way connected with any dispute
                  you may have with one or more Users.
                </AppText>
                ...
                <AppText
                  ...
                  Provident Fund contributions, work injury compensation or
                  other employment-related payments or benefits of any User.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{
                  ...
                  5. No Endorsement. Although the Platform may display or
                  suggest certain Users, Task Postings, Task Offers, Content
                  and/or other aspects of the Platform from time to time or may
                  indicate certain Users, Task Postings, Task Offers, Content
                  and/or other aspects of the Platform with special
                  characteristics (such as, being a verified User or having
                  certain ratings), it is not an endorsement of such Users, Task
                  Postings, Task Offers, Content and/or aspects of the Platform
                  and you are solely responsible for conducting your own due
                  diligence and other checks. If you proceed to enter into a
                  legal contract with any Users, you are doing so at your own
                  risk and you shall have no recourse to us.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{
                ...
                <AppText
                  ...
                  out of or in connection with this Agreement whenever made
                  shall be limited to SGD100.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{
                  ...
                  Agreement must be commenced within one (1) year after the
                  cause of action accrues, failing which such cause of action
                ...
                <AppText
                  ...
                  and all legal fees and expenses on a solicitor and client
                  basis in connection with any action, suit or proceeding)
                  suffered or incurred by any of the Indemnified Parties arising
                ...
                <AppText
                  ...
                  in this clause 10 shall be construed independently of the
                  others and shall not be limited by any other qualification or
                  limitation.
                </AppText>
                <AppText
                  textStyle="body1"
                  ...
                  11. Survival. The provisions of this clause 10 shall survive
            ...
            <View style={{ marginTop: normalize(24) }}>
              ...
              <View
                ...
                <AppText
                  ...
                  may from time to time modify or change any part of the
                  Platform without any reference or notice to you.
                </AppText>
                <AppText
                  textStyle="body1"
                  customStyle={{
                  ...
                  2. Changes to this Agreement. You acknowledge and agree that
                  we may from time to time change the terms of this Agreement by
              ...
              <View
                ...
                <View
                  ...
                  <AppText
                    ...
                    1. All notices and other communications given by us under
                    this Agreement (including any changes to this Agreement) may
                    be given by:
                  </AppText>
                  <View
                    style={{
                ...
                <AppText
                  ...
                  2. Such notices and communications shall be deemed received
                  when sent by us.
                </AppText>
                <View
                  style={{
                  ...
                  <View
                    ...
                    <AppText
                      ...
                      office address, which shall be deemed received one (1)
                      week following the day it was posted, together with a copy
                      sent by email to help@servbees.com (which shall not
                      constitute notice); or
                    </AppText>
                    <AppText
                      textStyle="body1"
                      customStyle={{
                      ...
                      one (1) month following the day it was posted, together
                      with a copy sent by email to help@servbees.com (which
                  ...
                  <View
                    ...
                    <AppText
                      ...
                      terrorism, riot, labour condition, governmental action,
                      and disruption or disturbance of the Internet or energy
                      sources that was beyond our reasonable control; or
                    </AppText>
                    <AppText
                      textStyle="body1"
                      customStyle={{
                  ...
                  <AppText
                    ...
                    3. Third Party Sites. Links to other third party sites may
                    be provided on the Platform. You acknowledge and agree that
                    (a) such links do not constitute an endorsement; (b) we have
                    no control over such websites or their Content; and (c) we
                    shall have no liability arising out of or related to such
                  ...
                  <AppText
                    ...
                    6. No Third Party Rights. Except for the Indemnified
                    Parties, a person who is not a party to this Agreement shall
                    have no right under the Contracts (Rights of Third Parties)
                    Act (Chapter 53B) of Singapore to enforce any provision of
                    this Agreement.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    ...
                    7. Variation. Any variation to any provision of this
                    Agreement must be in writing and executed by us.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    customStyle={{
                    ...
                    to be illegal, invalid or unenforceable in whole or in part
                    in any jurisdiction, then this Agreement shall, as to such
                    jurisdiction, continue to be valid as to its other
                    provisions and the remainder of the affected provision, and
                    the legality, validity and enforceability of such provision
                  ...
                  <AppText
                    ...
                    9. No Waiver. No delay or failure by us to exercise or
                    enforce any right, power or remedy under this Agreement
                    shall constitute or operate as a waiver of that right, power
                    or remedy or any other right, power or remedy under this
                    Agreement or operate so as to prevent the subsequent
                    exercise or enforcement of any such right, power or remedy.
                    Any waiver by us must be expressly made in writing and
                    signed by us to be effective.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    customStyle={{
                    ...
                    licences, interests and/or obligations at any time to
                    anyone, including as part of a merger, acquisition or other
                  ...
                  <AppText
                    ...
                    be Singapore. The Tribunal shall consist of one (1)
            ...
            <View style={{ marginTop: normalize(24) }}>
              ...
              <AppText
                ...
                the Poster and the Service Provider enter into a Service
              ...
              <View
                ...
                <View
                  ...
                  <AppText
                    ...
                    when the Tasker makes an Instant Claim.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    customStyle={{ marginTop: normalize(8) }}>
                ...
                <View
                  ...
                  <AppText
                    ...
                    Platform to release the Tasker Funds from the Payment
                    Account. For Recurring Services the Tasker Funds for an
                    Occurrence will automatically be released by Servbees from
                    the Payment Account to the Tasker unless paused by the
                    Poster in accordance with the User's Servbees Agreement.
                  </AppText>
                  <AppText
                    textStyle="body1"
                    customStyle={{ marginTop: normalize(8) }}>
