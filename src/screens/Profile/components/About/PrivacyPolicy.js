      ...
      <PaddingView paddingSize={3}>
        ...
        <ScrollView style={{marginTop: normalize(40)}}>
          ...
          <View
            ...
            <AppText textStyle="body1">
              4.1 Core Business Purpose. We may collect, use or process personal
              data for one or more of the following business purposes:
            </AppText>
            <View style={{paddingLeft: normalize(8)}}>
              <AppText
                textStyle="body1"
                customStyle={{marginTop: normalize(8)}}>
                4.1.1 to provide you with the Services; measure the performance
                of our Services; monitor the Services provided by or made
              ...
              <AppText
                textStyle="body1"
                customStyle={{marginTop: normalize(8)}}>
                4.1.6 prevent, detect and investigate fraud or other potentially
              ...
              <AppText
                textStyle="body1"
                customStyle={{marginTop: normalize(8)}}>
                4.1.7 address or investigate any complaints, claims or disputes;
              </AppText>
              ...
              <AppText
                ...
                (including information technology infrastructure) and complying
              ...
              <AppText
                ...
                regulatory, governmental, tax and law enforcement authorities or
            ...
            <View
              ...
              <AppText textStyle="body1">
                4.2 Marketing Purpose. We may also collect, use or process your
                personal data to:
              </AppText>
              <View style={{paddingLeft: normalize(8)}}>
                <AppText
                  ...
                  to you or for which you may be eligible), via various modes of
                ...
                <AppText
                  ...
                  or to participate in our advertisement personalization
          ...
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                5.1 We may from time to time disclose your personal data to any
                of our employees, personnel, our Service Providers or to third
                parties, whether located in Singapore or elsewhere, in order to
                carry out the purposes set out above. When we disclose your
                personal data to such persons, we will request that they also
          ...
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                7.1 You may request access, receive, port, restrict processing,
                seek rectification or make corrections to, or request erasure of
                your personal data held by us, but we may charge a fee for
                processing such requests. All such requests will be processed in
              ...
              <AppText textStyle="body1">
                7.3 There may be circumstances whereby we are unable to provide
                access, such as where the information contains legal privilege.
                If we determine that access should be restricted in any
                particular instance, we will explain why that determination was
                made and you may contact our Data Protection Officer for any
                further enquiries.
              </AppText>
              <AppText textStyle="body1">
                ...
                personal data found to be inaccurate, incomplete or out of date.
              </AppText>
            </View>
          </View>
          ...
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                8.1 We will take necessary steps to protect your personal data.
                However, no data transmission or storage of personal data can be
                guaranteed to be 100% secure. As such, we cannot ensure or
                warrant the security of any personal data that you transmit to
          ...
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                9.1 When you access or use our Services, we may store some data
                on your device using technologies such as a cookie or other
                local storage provided by your browser or application
                (collectively, the “Cookies”). Such data is stored on your
                device to enable us to (i) provide the Services; (ii) recognise,
                identify or authenticate you; (iii) customise our Services for
                you; (iv) provide advertising; (v) provide our measurements and
                reporting; and (vi) fulfil the other purposes set out above.
              </AppText>
              ...
              <AppText textStyle="body1">
                ...
                be liable for any failure to provide any Services to you if such
          ...
          <View
            ...
            <AppText textStyle="body1medium">10. THIRD PARTY SERVICES</AppText>
            <View
              style={{
                marginTop: normalize(24),
                paddingLeft: normalize(8),
              ...
              <AppText textStyle="body1">
                ...
                (“Google”) to help us improve our products. Accordingly, traffic
                and user behaviour data relating to our Services may be shared
                with Google. You can find out more about how Google collects and
                processes data here:
          ...
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                ...
                operated by third parties. Such links or redirections are not an
                endorsement of these third party sites nor of the third parties
                operating them. These third party sites may also have different
                data protection practices. We have no control over and do not
                take responsibility for these third party sites.
              </AppText>
            </View>
          </View>
          ...
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                ...
                after the notice period, you will be deemed to have consented to
                the amendments made in such revised version
              </AppText>
            </View>
          </View>
          <View
            ...
            <View
              ...
              <AppText textStyle="body1">
                ...
                [legal@servbees.com]. We will address your concerns and attempt
                to resolve any privacy or data protection issues in a timely
                manner.
              </AppText>
            </View>
          </View>
