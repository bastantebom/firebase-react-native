...
import { AppText, AppRadio, BottomSheetHeader } from '@/components'

import { normalize } from '@/globals'

import { Public } from '@/assets/images/icons'
      ...
      <View style={{ paddingTop: 30 }}>
        ...
        <View style={{ position: 'relative', paddingTop: 10 }}>
          ...
          <AppRadio
            label={
              <>
                <AppText textStyle="caption2">Public</AppText>
              </>
            }
            value={publicPost}
        ...
        <AppText textStyle="captionDashboard">
          Post can be seen by anyone on or off Servbees.
        </AppText>
      </View>
    </View>
  )
