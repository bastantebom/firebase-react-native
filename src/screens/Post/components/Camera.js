...
export const PostCamera = ({ cancel, next, data }) => {
  const { singleCameraImage, cameraImage, setCoverPhoto } = useContext(Context)
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View
        ...
        <TouchableOpacity
          ...
          <AppText
            textStyle="body3"
            color={!cameraCapture ? Colors.buttonDisable : Colors.contentOcean}>
            Next
          </AppText>
        </TouchableOpacity>
      </View>
